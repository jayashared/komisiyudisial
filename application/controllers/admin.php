...
class Admin extends CI_Controller {
    ...
    public function email_configuration() {
        try {
            ...
            $crud->fields('useragent', 'protocol', 'mailpath', 'smtp_host', 'smtp_user', 'name', 'smtp_pass', 'smtp_port', 'smtp_timeout', 'wordwrap', 'wrapchars', 'mailtype', 'charset', 'validate', 'priority', 'crlf', 'newline', 'bcc_batch_mode', 'bcc_batch_size', 'subjek', 'format_email_balasan', 'subjek_lupa_password', 'format_lupa_password', 'modified_by', 'modified_date');
    ...
    public function contact_us() {
        try {
            ...
            $crud->fields('name', 'email', 'subject', 'message', 'answer', 'is_reply', 'modified_by', 'modified_date');
