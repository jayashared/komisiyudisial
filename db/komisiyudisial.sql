...
CREATE TABLE IF NOT EXISTS `tbl_laws` (
  ...
  `id_laws_category` int(11) NOT NULL DEFAULT '0',
...
INSERT INTO `tbl_laws_category` (`id_laws_category`, `laws_category_id`, `laws_category_en`, `modified_by`, `modified_date`) VALUES
	...
	(2, 'Peraturan', 'Rules', 1, '2015-05-05 11:20:03');
...
CREATE TABLE IF NOT EXISTS `tbl_publication` (
  ...
  `id_publication_category` int(11) DEFAULT NULL,
  ...
  KEY `FK_tbl_publication_tbl_publication_category` (`id_publication_category`),
  CONSTRAINT `FK_tbl_publication_tbl_publication_category` FOREIGN KEY (`id_publication_category`) REFERENCES `tbl_publication_category` (`id_publication_category`) ON DELETE SET NULL ON UPDATE SET NULL,
...
-- Dumping structure for table komisiyudisial.tbl_publication_category
DROP TABLE IF EXISTS `tbl_publication_category`;
CREATE TABLE IF NOT EXISTS `tbl_publication_category` (
  `id_publication_category` int(11) NOT NULL AUTO_INCREMENT,
  `title_id` varchar(255) NOT NULL,
  `title_en` varchar(255) NOT NULL,
  `modified_by` int(10) DEFAULT NULL,
  `modified_date` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id_publication_category`),
  KEY `FK_tbl_publication_category_tbl_user` (`modified_by`),
  CONSTRAINT `FK_tbl_publication_category_tbl_user` FOREIGN KEY (`modified_by`) REFERENCES `tbl_user` (`id_user`) ON DELETE SET NULL ON UPDATE SET NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

-- Dumping data for table komisiyudisial.tbl_publication_category: ~0 rows (approximately)
/*!40000 ALTER TABLE `tbl_publication_category` DISABLE KEYS */;
/*!40000 ALTER TABLE `tbl_publication_category` ENABLE KEYS */;


-- Dumping structure for table komisiyudisial.tbl_public_service
DROP TABLE IF EXISTS `tbl_public_service`;
CREATE TABLE IF NOT EXISTS `tbl_public_service` (
  `id_public_service` int(11) NOT NULL AUTO_INCREMENT,
  `id_public_service_category` int(11) DEFAULT NULL,
  `title_id` varchar(255) NOT NULL,
  `title_en` varchar(255) NOT NULL,
  `text_id` text,
  `text_en` text,
  ...
  `modified_by` int(11) DEFAULT NULL,
  `modified_date` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id_public_service`),
  KEY `FK_tbl_public_service_tbl_public_service_category` (`id_public_service_category`),
  KEY `FK_tbl_public_service_tbl_user` (`modified_by`),
  CONSTRAINT `FK_tbl_public_service_tbl_public_service_category` FOREIGN KEY (`id_public_service_category`) REFERENCES `tbl_public_service_category` (`id_public_service_category`) ON DELETE SET NULL ON UPDATE SET NULL,
  CONSTRAINT `FK_tbl_public_service_tbl_user` FOREIGN KEY (`modified_by`) REFERENCES `tbl_user` (`id_user`) ON DELETE SET NULL ON UPDATE SET NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

-- Dumping data for table komisiyudisial.tbl_public_service: ~0 rows (approximately)
/*!40000 ALTER TABLE `tbl_public_service` DISABLE KEYS */;
/*!40000 ALTER TABLE `tbl_public_service` ENABLE KEYS */;


-- Dumping structure for table komisiyudisial.tbl_public_service_category
DROP TABLE IF EXISTS `tbl_public_service_category`;
CREATE TABLE IF NOT EXISTS `tbl_public_service_category` (
  `id_public_service_category` int(11) NOT NULL AUTO_INCREMENT,
  `public_service_category` varchar(255) DEFAULT NULL,
  `modified_by` int(11) DEFAULT NULL,
  `modified_date` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id_public_service_category`),
  KEY `FK_tbl_public_service_category_tbl_user` (`modified_by`),
  CONSTRAINT `FK_tbl_public_service_category_tbl_user` FOREIGN KEY (`modified_by`) REFERENCES `tbl_user` (`id_user`) ON DELETE SET NULL ON UPDATE SET NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

-- Dumping data for table komisiyudisial.tbl_public_service_category: ~0 rows (approximately)
/*!40000 ALTER TABLE `tbl_public_service_category` DISABLE KEYS */;
/*!40000 ALTER TABLE `tbl_public_service_category` ENABLE KEYS */;
...
-- Dumping data for table komisiyudisial.tbl_sitemap: ~24 rows (approximately)
...
INSERT INTO `tbl_sitemap` (`id_sitemap`, `sitemap_code`, `id_parent`, `name`, `description`, `title_id`, `title_en`, `url`, `css_class`, `css_id`, `icon`, `sort_no`, `modified_by`, `modified_date`) VALUES
	...
	(8, '01.01', 7, 'home', 'Frontend - Home', 'Home', 'Home', 'frontend', NULL, NULL, NULL, 1, 1, '2015-05-05 22:43:06'),
	(9, '01.02', 7, 'tentang_ky', 'Frontend - Tentang KY', 'Tentang KY', 'About KY', 'about_ky', '', '', '', 2, 1, '2015-04-23 15:55:37'),
	(10, '01.02.01', 9, 'sejarah_pembentukan', 'Frontend - Sejarah Pembentukan', 'Sejarah Pembentukan', 'History', 'frontend/static_content/sejarah', NULL, NULL, NULL, 3, 1, '2015-05-05 12:53:08'),
	(11, '01.02.02', 9, 'visi_misi', 'Frontend -Visi dan Misi', 'Visi dan Misi', 'Vision and Mision', 'frontend/static_content/visi_misi', NULL, NULL, NULL, 4, 1, '2015-05-05 12:55:20'),
	...
	(15, '01.06', 7, 'berita', 'Frontend - Berita', 'Berita', 'News', 'frontend/news', '', '', '', 8, 1, '2015-05-05 19:10:11'),
	(16, '01.07', 7, 'hubungi_kami', 'Frontend - Hubungi Kami', 'Hubungi Kami', 'Contact Us', 'frontend/static_content/hubungi_kami', NULL, NULL, NULL, 9, 1, '2015-05-05 22:55:17'),
	...
	(28, '02.07', 17, 'Video', 'Administrator - Video', 'Video', 'Video', 'video', NULL, NULL, NULL, 7, 1, '2015-05-05 11:13:22'),
	(29, '02.08', 17, 'Artikel', 'Administrator - Artikel', 'Artikel', 'Article', 'artikel', NULL, NULL, NULL, 8, 1, '2015-05-05 11:14:45'),
	(30, '02.09', 17, 'Hukum', 'Administrator - Hukum', 'Hukum', 'Laws', '#', NULL, NULL, NULL, 10, 1, '2015-05-05 11:15:24'),
	(31, '02.09.01', 30, 'Kategori Hukum', 'Administrator - Kategori Hukum', 'Kategori', 'Category', 'KategoriHukum', NULL, NULL, NULL, 11, 1, '2015-05-05 11:19:49'),
	(32, '02.09.02', 30, 'Daftar Hukum', 'Administrator - Daftar Hukum', 'Daftar', 'List', 'Hukum', NULL, NULL, NULL, 12, 1, '2015-05-05 11:18:05'),
	(33, '02.10', 17, 'Publikasi Admin', 'Administrator - Publikasi', 'Publikasi', 'Publication', 'Publikasi', NULL, NULL, NULL, 12, 1, '2015-05-05 11:19:02'),
	(34, '01.02.03', 9, 'Tujuan', 'Frontend - Tujuan', 'Tujuan', 'Purpose', 'frontend/static_content/tujuan', NULL, NULL, NULL, 5, 1, '2015-05-05 12:57:44'),
	(35, '01.04.01', 13, 'Undang-undang', 'Frontend - Undang-undang', 'Undang-undang', 'Constitution', 'frontend/constitution', NULL, NULL, NULL, 1, 1, '2015-05-05 22:45:44'),
	(36, '01.04.02', 13, 'Peraturan', 'Frontend - Peraturan', 'Peraturan', 'Regulation', 'frontend/regulation', NULL, NULL, NULL, 2, 1, '2015-05-05 22:47:38');
...
CREATE TABLE IF NOT EXISTS `tbl_static_content` (
  ...
  UNIQUE KEY `static_content` (`static_content`),
...
-- Dumping data for table komisiyudisial.tbl_static_content: ~3 rows (approximately)
/*!40000 ALTER TABLE `tbl_static_content` DISABLE KEYS */;
INSERT INTO `tbl_static_content` (`id_static_content`, `static_content`, `title_id`, `title_en`, `text_id`, `text_en`, `modified_by`, `modified_date`) VALUES
	(1, 'sejarah', 'Sejarah Pembentukan', 'History', 'sejarah', 'sejarah', 1, '2015-05-05 12:54:12'),
	(2, 'visi_misi', 'Visi dan Misi', 'Vission and Mission', 'visi_misi', 'visi_misi', NULL, '2015-05-05 12:54:22'),
	(3, 'tujuan', 'Tujuan', 'Purpose', 'Tujuan KY', 'KY Purpose', NULL, '2015-05-05 12:54:30'),
	(4, 'hubungi_kami', 'Hubungi Kami', 'Contact Us', 'Coba hubugi Kami', 'Try Conbtact Us', NULL, '2015-05-05 22:54:25');
